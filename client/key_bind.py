...
root.bind('<KeyPress-j>', lambda _: send('headleft'))
root.bind('<KeyPress-l>', lambda _: send('headright'))
root.bind('<KeyPress-u>', lambda _: send('low'))
root.bind('<KeyPress-o>', lambda _: send('high'))
